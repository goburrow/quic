...
// https://quicwg.org/base-drafts/draft-ietf-quic-tls.html#client-initial
func TestDecryptInitialPacket(t *testing.T) {
	const clientInitial = `
...
c9be6c7803567321829dd85853396269`
	...
	t.Logf("client payload len=%d", len(payload))
...
432348a2c413`
	...
	t.Logf("server payload len=%d", len(payload))
}
